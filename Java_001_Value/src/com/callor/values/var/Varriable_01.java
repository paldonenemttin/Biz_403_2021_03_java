...
public class Varriable_01 {
	...
	public static void main(String[] srgs) {
		 ...
		 *      CPU controller가 하는 일
		 * 4. 어딘가에 보관된 40을 cpu의 여산장치로 이동
		 * 5. + 를 분석하여 두숫자의 덧셈을 계산하라는 
		 *     명령을 인식
		 * 6. 두수를 덧셈장치(Adder)에 보내서 덧셈을 수행
		 * 7. 덧셈한 결과를 기억장치 어딘가에 보관
		 * 8. println() 에게 덧셈 결과가 보관된 기억장소
		 * 위치(주소)를 알려준다
		 * 9. println() 덧셈 결과가 보관된 기억장소를 찾아가서
		 * 보관값을 가져와서 Sysrtem.out 한테 보낸다
