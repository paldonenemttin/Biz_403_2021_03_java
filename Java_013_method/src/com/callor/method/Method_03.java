...
public class Method_03 {
	...
	public static void main(String[] args) {
		 ...
		 * 호출하여 명령을 수행하고 싶다
		 * 이때 c와 같은 언어는 단순히 method이름만 호출하여 명령 수행 가능
		 * 이런 type을 함수(function call)이라고 한다
		 * 
		 * inputNum();
		 * 
		 * 다만, 자바는 이러한 함수 호출 방식으로 명령을 수행 할 수 없다
		 * 
		 * 클래스에 저으이된 method를 호출하여 명령을 수행하려면
		 * 1. 클래스를 사용하여 객체를 생성해야 하낟
		 * 2. 객체와 연결 연산자를 사용하여 호출한다
		 * 
		 ...
		 *  return 하도록 되어 있다
		 *  따라서 이 method를 단순히 호출만 하는 것은 아무런 의미 없음
		 *  
		 ...
		 *  method가 return하는 값을 받아서 변수에 저장 가능
		 */
		Integer retNum = nsV1.inputNum1();
