...
public class String_01 {
	...
	public static void main(String[] args) {
		...
		//문자 변수 : 알파벳 한글자만 저장
		// 표현은 작은 따옴표('')로 감싼다
		// 문자는 알파벳으로 읽히지만 변수에 저장될땐 정수형 아스키 코드값으로 저장
		//그래서 정수와 사직연산이 가능하다
		char char1 = 'A';
		...
		// str1에 담긴 문자열을 아팝벳 단위로 잘라서 배열로 만들어라
		str3 = str1.split("");
		for(int i= 0; i < str3.length ; i++);{
			System.out.println(str3[1]);
		}
