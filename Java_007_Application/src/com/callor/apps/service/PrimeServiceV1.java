 ...
 *      기존 프로젝트를 V1이라 하고
 *      새롭게 기능이 개선 또는 추가되어 배포된 프로젝트를
 *      V2.xx 라고 칭하여 배포한다
 * 
 */

/*
 * main() method에서 배열을 만드록
 * 값을저장한 다음, Prime 인가를 검사해서 출력했다
 * 
...
// class 이름짓기
//      첫글자 대문 이후는 Camel case 
//           (Upper)Camel case라고 한다
...
public class PrimeServiceV1 {
	...
	//       변수를 사용한다 = 변수를 참고: 저장 , 읽기
	// 클래스 영역에 설정을 한다
	int[] intNums;// int[] intNums = new int[20]
	//프라임메서드에서 공통으로 사용될 변수
